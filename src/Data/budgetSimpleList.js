const budgetSimpleList = [
  ...
  'Used TypeScript to limit errors and enhance code clarity and self-documentation',
  'Distilled complex financial concepts into succinct instructional content',
