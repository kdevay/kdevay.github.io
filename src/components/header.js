...
export default function Header(props) {
    ...
    // State selector
    const [isASelected, setIsASelected] = useState(tab === 'about' ? 'selected' : '');
    const [isPSelected, setIsPSelected] = useState(tab === 'projects' ? 'selected' : '');
    const [isRSelected, setIsRSelected] = useState(tab === 'resume' ? 'selected' : '');
    // State color
